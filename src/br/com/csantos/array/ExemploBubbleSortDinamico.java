...
public class ExemploBubbleSortDinamico {
    public static void main(String args[]) {
        ...
        String resposta = s.next(); // Corrigido o erro de atribuição
        ...
        for (i = 0; i < vet.length; i++) {  // Corrigido o loop for
    ...
    // Método para converter um array de String para int
